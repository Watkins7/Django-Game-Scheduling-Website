# Generated by Django 4.0.3 on 2022-04-26 01:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gameType', models.TextField(verbose_name=20)),
            ],
        ),
        migrations.CreateModel(
            name='TimeSlot',
        ...
        migrations.AddConstraint(
            model_name='timeslot',
            constraint=models.UniqueConstraint(fields=('team', 'slot_start', 'slot_end'), name='pick_up_app_timeslot_unique_team_slot'),
        ),
        migrations.AddConstraint(
            model_name='timeslot',
        ...
        migrations.AddConstraint(
            model_name='mmr',
            constraint=models.CheckConstraint(check=models.Q(('MMR_rating__gte', 0)), name='Positive_MMR_Values'),
        ),
        migrations.AddConstraint(
            model_name='emails',
